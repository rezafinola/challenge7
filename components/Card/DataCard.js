...
import "react-medium-image-zoom/dist/styles.css";import React, { useState, useEffect } from 'react';
  ...
  return (
    <div>
      {students.map((student) => {
        ...
        >
          <Zoom>
            {student.attributes.image.data === null && (
              <img src="/image/duck.jpg" alt="student" width="100" />
            )}
            {student.attributes.image.data !== null && (
              <img
                src={student.attributes.image.data.attributes.url}
                alt="student"
                width="100"
              />
            )}
            ...
            <div className='row'>
              <div className='col'>
                <Card style={{ width: '20rem' }}>
                  <Card.Img src={student.attributes.image.data.attributes.url} />
                  <Card.Body>
